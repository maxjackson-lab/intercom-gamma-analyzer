...
# Snapshot commands (list-snapshots, export-snapshot-schema, compare-snapshots)
# have been moved to src/cli/snapshot_commands.py as part of Phase 1.2 refactor.
# See docs/CLI_COMMAND_INVENTORY.md for migration status.
